...
export const SUPPLEMENTAL_SERVICE_TEMPLATES: CatalogItem[] = [
  ...
  },
  {
    ...
    name: "Editorial",
    description:
      "Editorial or advertorial feature placed with a selected publication, written and coordinated with the outlet.",
    category: "print_press",
    setupTimeValue: 10,
    setupLeadDays: 10,
    notes: "Cost to be confirmed per publication.",
  },
  {
    ...base,
    catalogId: "radio_ad",
    name: "Radio ad",
    description:
      "Radio commercial production and airtime across selected stations, with the schedule confirmed in the final brief.",
    category: "radio",
    mediaEditable: true,
    setupTimeValue: 15,
    setupLeadDays: 15,
    notes: "Airtime rate to be confirmed per station.",
  },
  {
    ...base,
    catalogId: "tv_ad",
    name: "TV ad",
    description:
      "Television commercial production and airtime across selected networks or regions, with the schedule confirmed in the final brief.",
    category: "tv",
    mediaEditable: true,
    setupTimeValue: 20,
    setupLeadDays: 20,
    notes: "Airtime rate to be confirmed per network.",
  },
];
