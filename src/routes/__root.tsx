  ...
  head: () => ({
    meta: [
      ...
      },
      {
        property: "og:image",
        content:
          "https://storage.googleapis.com/gpt-engineer-file-uploads/D7VJ8gACpSgtyecCtkbK6S55d3L2/social-images/social-1785901518261-social-image.webp",
      },
      {
        name: "twitter:image",
        content:
...
})(window,document,'script','dataLayer','GTM-N695JK5S');`,
      },
      {
        async: true,
        src: "https://www.googletagmanager.com/gtag/js?id=G-927WGGV0VQ",
      },
      {
  ...
  return (
    <html lang="en">
      ...
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-N695JK5S"
            height="0"
            width="0"
